...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">projeto-lunacao-front documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-dfd6e3f8afd491975e2c6e247750abcb"' : 'data-target="#xs-components-links-module-AppModule-dfd6e3f8afd491975e2c6e247750abcb"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-dfd6e3f8afd491975e2c6e247750abcb"' :
                                            'id="xs-components-links-module-AppModule-dfd6e3f8afd491975e2c6e247750abcb"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/EducativoComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">EducativoComponent</a>
                                            </li>
                                            <li class="link">
